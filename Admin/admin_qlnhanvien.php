      ...
      <div class="overview">
        <div class="contenr-header">
          <div class="view-oder">
            <div class="oder-text">
              <i class="fa-solid fa-newspaper"></i>
              <p class="text-about">Quản lý nhân viên</p>
            </div>
            <ul class="oder-nav">
        ...
        <div class="overview_7">
          <div class="overview_5-header">
            <div style="margin-top: 25px;" class="header-seach">
              <div class="button-saech1">
                ...
                <form action="/BE/nhanvien/add-nhanvien.php" method="POST" class="input-nv">
                <input style="width: 136px;" type="submit" value="Thêm nhân viên mới" class="new-button1">
                </form>
              </div>
            </div>
                    ...
                    <tbody>
                      <?php foreach ($user as $u) : ?>
                        <tr>
                          ...
                          <td><?php echo $u['quequan'] ?></td>
                          <td><?php echo $u['chucvu'] ?></td>
                          <td><?php echo $u['password'] ?></td>
                          <td>
                            <a href="/BE/nhanvien/form-upd-nv.php?id=<?php echo $u['id'] ?>">Sửa</a> | <a href="/BE/nhanvien/delete-nv.php?id=<?php echo $u['id'] ?>">Xóa</a>
                          </td>
